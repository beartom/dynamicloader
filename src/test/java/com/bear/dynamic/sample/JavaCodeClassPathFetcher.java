 ...
 * @version
 */
public class JavaCodeClassPathFetcher implements IJavaCodeFetcher {

	private static final Logger log = LoggerFactory.getLogger(JavaCodeClassPathFetcher.class);
	 ...
	 * 
	 */
	public JavaCodeClassPathFetcher(Map<String, String> sourceCodeFileMap) {
		super();
	...
	public String getJavaCode(String name) {
		...
		try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader()
